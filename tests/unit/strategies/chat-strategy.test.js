...
describe('ChatStrategy', () => {
  ...
  describe('execute', () => {
    it('should return a response based on the input', async () => {
      ...
      expect(mockGenai.chatQuery).toHaveBeenCalledWith(expect.any(String), mockInput);
    });
    ...
    it('should handle errors gracefully', async () => {
      ...
      await expect(chatStrategy.execute(mockInput)).rejects.toThrow('Processing error');
    });
  });
});
